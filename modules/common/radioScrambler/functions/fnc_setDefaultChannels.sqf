private["_radioClass", "_channelsArray", "_array", "_run", "_go", "_radioClassBare"];
...
{ // forEach
	{
		(_x getVariable ("acre_sys_" + _radioClassBare + "_channels")) set [_foreachindex, (_channelsArray select _foreachindex)];
